  ...
  return (
    <section>
      <div className="text-center">
        <h1 className="text-3xl md:text-4xl tracking-tight md:tracking-tighter leading-tight" >
          Support this project by staking your
          <svg role="img" className="fill-current inline-block h-10 w-10" xmlns="http://www.w3.org/2000/svg"
            x="0px" y="0px" viewBox="0 0 190 190">
            <title>Racex Pool ADA</title>
            <g>
          ...
          with <a href="https://racexpool.com">
            <img src="/images/logo-racex.svg" alt="logo" className="fill-current inline-block h-16 w-16" /> <strong>RaceX</strong></a>.
        </h1>
      </div>
    </section>
  )
