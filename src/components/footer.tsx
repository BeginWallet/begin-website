        ...
        <div className="p-2 pt-0 lg:p-6 lg:pt-4 lg:-mt-16 flex flex-col flex-wrap justify-center w-full">
          <div className='p-4 lg:p-12 mb-6 flex flex-col items-center lg:items-left lg:flex-row bg-blue-over text-white rounded-2xl w-full'>
            <div className='flex-grow'>
              <a href="https://twitter.com/B58Wallet" target="_blank" className="text-2xl lg:text-4xl hover:text-blue-light sm:p-6 lg:p-0">
            ...
            <div className='w-full lg:w-1/3 lg:text-right'>
              <a href="#" role="button" className="bg-blue-discord hover:border-white hover:shadow-lg hover:bg-white hover:text-blue-light text-sm text-white w-full lg:w-40 h-12 rounded-xl inline-flex items-center justify-center">
                Discord
              </a>
            </div>
          </div>
          ...
          <div className='p-4 lg:p-12 mb-6 flex flex-col items-center lg:items-left lg:flex-row bg-blue-over text-white rounded-2xl w-full'>
            ...
            <div className='w-full lg:w-1/3 lg:text-right'>
              <a href="#" role="button" className="bg-blue-twitter hover:border-white hover:shadow-lg hover:bg-white hover:text-blue-light text-sm text-white w-full lg:w-40 h-12 rounded-xl inline-flex items-center justify-center">
                Twitter
              </a>
            </div>
          </div>
