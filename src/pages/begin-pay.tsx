          ...
          <section id="generate" className="mx-auto flex flex-col justify-center items-center">
            ...
            >
              ...
              >
                ...
                >
                  <QRCode
                    value={`web+cardano:${paymentData.address}?amount=${paymentData.amount}&paymentId=${paymentData.paymentId}&token=${paymentData.token}&note=${paymentData.note}`}
            ...
            <div>
              <div className="flex flex-col lg:flex-row justify-center p-6">
                <a
                  ...
                  href="web+cardano:addr1qyc82mg805qw8duqf44h8futyhfj0zxmu57pm4wsa8jwyyc6e9h5gr8y263u3chg4n6p8zpnn2359xzr55yx6enkr8kqw4pau0?amount=1&paymentId=123-abc&token=&note=test 1234"
                  // target="_blank"
                  role="button"
